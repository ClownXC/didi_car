...
public class JedisUtil {
    ...
    static {
        ...
        System.out.println(GlobalConfigUtils.getProp(ConfigConstants.JEDIS_PASS));
        jedisPool = new JedisPool(
                config,
                GlobalConfigUtils.getProp(ConfigConstants.JEDIS_HOST),
                Integer.parseInt(GlobalConfigUtils.getProp(ConfigConstants.JEDIS_PORT)),
                10000,
                GlobalConfigUtils.getProp(ConfigConstants.JEDIS_PASS));
    }
